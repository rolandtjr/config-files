...
layouts = [
    ...
    layout.Max(),
    layout.MonadTall(border_focus=nord["nord11"], border_normal=nord["nord10"], border_width=4, margin=4),
]
...
clock = widget.Clock(background=nord["nord11"], foreground=nord["nord0"], padding=4, format="%Y-%m-%d %a %H:%M")
    ...
    Screen(  # Screen1
        bottom=bar.Bar(
            [
                ...
                widget.Spacer(background=nord["nord0"], length=6),
                clock,
                widget.WidgetBox(
                    name="shutdown",
                ...
                widget.Spacer(background=nord["nord11"], length=4),
            ],
            size=32,
